...
export const isMediumMobile = () =>
  window.innerWidth >= 375 && window.innerWidth < 414;

export const isLargeMobile = () =>
  window.innerWidth >= 414 && window.innerWidth <= 750;

export const isScreen750to1440 = () =>
  window.innerWidth >= 750 && window.innerWidth < 1440;
